...
CREATE TABLE `descuentos` (
  ...
  `lgeneral` varchar(10) DEFAULT NULL,
  `descservicio` varchar(10) DEFAULT NULL,
  `descespecial` varchar(10) DEFAULT NULL,
...
INSERT INTO `descuentos` VALUES (1,'dkfj','h','ghfg','fhbg');
...
INSERT INTO `empleados` VALUES (1,'admin','12345','','Emmanuel ','Frias','Gonzalez','03/05/1988 12:00:00 a. m.','','','','','21/03/2014 12:00:00 a. m.',1),(2,'cajero1','12345','','Juan','Perez','Materno','03/03/1989 12:00:00 a. m.','','','','','21/03/2014 12:00:00 a. m.',2),(3,'Usuario','Password','asd','asd','asd','asd','28/03/2014 12:00:00 p.m.','Direccion','Colonia','Municipio','Estado','28/03/2014 12:00:00 p.m.',2),(5,'Usuario','Password','CURP','Nombre','Paterno','Materno','2014-03-00 00:00:00','Direccion','Colonia','Municipio','Estado','2014-03-00 00:00:00',2);
...
INSERT INTO `servicio` VALUES (1,'Lavado',12.5),(2,'Secado',20.05),(3,'Cera Economica',15),(4,'Cera Standard',30),(5,'Cera Superlux',150),(7,'servicio2',0),(10,'servicio2',0),(11,'servicio2',0),(12,'engradado de pisto',12.53),(16,'servicio2',0),(18,'encerado',0),(19,'cera',10);
...
-- Dump completed on 2014-04-02 19:19:34
