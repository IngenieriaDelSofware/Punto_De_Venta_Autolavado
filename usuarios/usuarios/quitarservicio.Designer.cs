...
namespace usuarios
{
	partial class quitarservicio
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Advertencia esta a punto de eliminar un servicio del sistema";
			// 
			// label2
			// 
			...
			this.Name = "quitarservicio";
			this.Text = "quitarservicio";
